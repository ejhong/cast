# A beautiful process atlas

The central question is: **what becomes easier if the material is workable before it becomes stone?**

Use quiet, tactile visualizations: warm paper, large Newsreader type, fine technical labels, green-black stages, rough stone, timber grain, and woven cloth. Let each process have one memorable action. Keep prose close to the thing it explains.

The front page is a narrative and an atlas. Each independent study has an observable feature, a proposed mechanism, an animated sequence, its implications, a comparison, and a physical test. Aletheia remains the place for the detailed evidence case.

## First collection

| Study | Memorable action | What it could explain | Next improvement |
| --- | --- | --- | --- |
| Pumapunku | A multipart mold opens around an H-block | Recesses, repeated geometry | A documented artifact mesh and a mechanically complete mold |
| Inca walls | A yielding mass takes the shape of its neighbors | Tight, irregular joints | Measured shrinkage and adhesion from an actual mix |
